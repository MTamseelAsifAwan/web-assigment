...
$exerciseTitles = [
  ...
  "6- Barbell T-Bar Rows"
  // Add more exercise titles here if needed
];



$sql = "SELECT * FROM backb";
...
<head>
  ...
  <title>Back Exercises with Barbells</title>
...
<body id="top">
  ...
  <?php endif; ?>
    ...
    <h1 style="color: white;padding-left: 70px; font-size: 32px; ">Back Exercises with Barbells</h1>
<p>
    <br>
</p>
     <!-- Exercise 1 -->
