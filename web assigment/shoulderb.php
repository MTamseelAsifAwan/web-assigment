...
$exerciseTitles = [
  ...
  "4- Barbell Shrugs",
  "5- Barbell Lateral Raises"
  // Add more exercise titles here if needed
];


$sql = "SELECT * FROM bshoulder";
...
<head>
  ...
  <title>Shoulder Exercises with Barbells</title>
...
<body id="top">
  ...
  <?php endif; ?>
    ...
    <h1 style="color: white;padding-left: 70px; font-size: 32px; ">Shoulder Exercises with Barbells</h1>
<p>
    <br>
</p>
     <!-- Exercise 1 -->
