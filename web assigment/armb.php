...
$exerciseTitles = [
  ...
  "5- Barbell Overhead Tricep Extensions",
  "6- Barbell Hammer Curls"
  // Add more exercise titles here if needed
];



$sql = "SELECT * FROM armb";
...
<head>
  ...
  <title>Arm Exercises with barbells</title>
...
<body id="top">
  ...
  <?php endif; ?>
    ...
    <h1 style="color: white;padding-left: 70px; font-size: 32px; ">Arm Exercises with barbells</h1>
<p>
    <br>
</p>
     <!-- Exercise 1 -->
