...
$exerciseTitles = ["1-Shoulder Press", "2- Lateral Raises", "3- Front Raises","4- Upright Rows","5- Arnold Press","6- Reverse Flyes","7- Shrugs"]; // Add all exercise titles

$sql = "SELECT * FROM dshoulder";
...
<head>
  ...
  <title>Arm Exercises with Dumbbells</title>
...
<body id="top">
  ...
  <?php endif; ?>
    ...
    <h1 style="color: white;padding-left: 70px; font-size: 32px; ">Shoulder Exercises with Dumbbells</h1>
<p>
    <br>
</p>
     <!-- Exercise 1 -->
