          ...
          <div class="hero-content">
            <div class="exercise-table">
              <section class="exercise-section">
                <h1 style="color: black; padding-left: 70px; font-size: 32px;">Weight Lifting</h1>
                <p><br></p>
...
<div class="data" style="color: black; width: 900px;  overflow: hidden; border: 1px solid transparent;">
                ...
                <?php
                include 'config2.php'; // Include the database connection
                $selectedTitles = ["The Power of Weight Lifting: Building Strength, Confidence, and Health","Precision and Technique"];

                $sql = "SELECT * FROM lifting";
                ...
                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                        ...
                        foreach ($selectedTitles as $selectedTitle) {
                          ...
                          if (strcasecmp($fetchedTitle, $selectedTitle) === 0) {
